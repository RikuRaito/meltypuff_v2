...
export default function Page() {
    ...
    const tabButtonClass = (tab: string) =>
        `w-full rounded-xl border-2 border-transparent hover:bg-[#b43353] hover:text-white px-5 py-3 text-base font-semibold transition-colors duration-200 sm:w-auto ${activeTab === tab
